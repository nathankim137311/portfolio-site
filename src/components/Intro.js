  ...
  return (
    <div className='relative flex flex-col justify-center h-screen'>
      <div className='flex flex-col items-start px-6 text-white xs:items-center xs:max-w-2xl sm:mx-auto z-[1]'>
        <div>
          <h1 className='text-6xl text-transparent font-archivo xs:text-center bg-clip-text bg-gradient-to-tl from-[#A400FF] to-[#ED018C]'>Nathan Kim.</h1>
          <p className='mt-4 mb-8 text-lg text-slate-300 xs:text-xl xs:text-center'>I am a <strong>software developer</strong> that builds and designs responsive web applications.</p>
        </div>
