...
const ProjectCard = ({ project }) => {
    return (
        <>
            <div className='flex flex-col items-center justify-center px-4 pt-10 pb-6 text-black bg-[#E2E2E2] shadow-lg rounded-xl'>
                <div className='w-full h-32'>
                    <img className='object-cover object-top w-full h-full rounded-md shadow-md' src={ project.img_url } alt="" />
                </div>
                ...
                <div className='flex items-center justify-between w-full py-6'>
                    ...
                    <Link className='bg-[#A400FF] text-white text-sm py-2 rounded-md px-4 hover:bg-transparent hover:text-black border-[#A400FF] border-2 shadow-lg' to={ `/projects/${project.query}` }
                    >
                        Live site
                    </Link>
                </div>
