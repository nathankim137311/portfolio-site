        ...
        <div className='max-w-5xl px-6 py-20 shadow-lg xs:px-10 xs:mx-auto'>
            ...
            <div className='bg-[#0E131F] rounded-xl px-4 py-10 xs:py-14 xs:px-8'>
                <div className='text-base xs:text-lg text-slate-300 md:text-xl'>
                    <p className='mb-4 text-left xs:mb-6'>I am a software developer that has a background in digital art. I combine my skills as an artist and my passion for technology to make my ideas come to life. <strong className='font-bold text-[#15ebd9]'>I am a creator</strong>, I always have been. From playing with legos, painting on canvas, or typing lines of code on an IDE, I love creating and that is my passion.</p>
